app.controller('dakamembercoincount', ['$rootScope', '$scope', '$http', 'utilsService', function ($rootScope, $scope, $http, utilsService) {
    ...
    function initComments(){
        ...
        function getCommentsData(num){
            ...
            $http.get(url).success(function(data){
                ...
                utilsService.formatDataByOrderAndNum(data.result, 0, num, ["coins", "avgcoin"]);

                var rs =  utilsService.getFormatData(data.result, "time");
                var ls =  utilsService.getFormatData(data.result, "coins");
                var avgls =  utilsService.getFormatData(data.result, "avgcoin");
