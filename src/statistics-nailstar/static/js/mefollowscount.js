app.controller('dakameFollowsCount', ['$rootScope', '$scope', '$http', 'utilsService', function ($rootScope, $scope, $http, utilsService) {
    ...
    function initComments(){
        ...
        function getCommentsData(num){
            ...
            $http.get(url).success(function(data){
                ...
                var rs =  utilsService.formatDataByOrderAndNumX(data.result, 0, num);
                var ls =  utilsService.formatDataByOrderAndNumY(data.result, 0, num, "count");
