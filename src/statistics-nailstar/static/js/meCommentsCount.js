app.controller('dakamecommentscount', ['$rootScope', '$scope', '$http', 'utilsService', function ($rootScope, $scope, $http, utilsService) {
    ...
    function initComments(){
        ...
        function getCommentsData(num){
            ...
            var url = "/svc/dakatongji/me/detailsCommentsCount?num=" + num;
            $http.get(url).success(function(data){

                $scope.totalcount = data.result.totalCount;

                var rs =  utilsService.formatDataByOrderAndNumX(data.result.details, 0, num);
                var ls =  utilsService.formatDataByOrderAndNumY(data.result.details, 0, num, "count");
