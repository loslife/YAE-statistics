app.controller('communitiesPostsSingleCount', ['$rootScope', '$scope', '$http', 'utilsService', function ($rootScope, $scope, $http, utilsService) {
    ...
    function initCommunities(){
        ...
        $scope.CateParams = {
            ...
            num: 20,//初始数据数量
            changeNum: function(){
                getCommunitiesPostsSingleData($scope.CateParams.id, $scope.CateParams.num);
            },
            keyDown: function(){
                if(event.keyCode == 13){
        ...
        //获取播放数据
        function getCommunitiesPostsSingleData(id, num){
            ...
            var url = "/svc/dakatongji/communities/communitiesPostsSingleCount?id=" + id + "&num=" + num;
            $http.get(url).success(function(data) {
                ...
                console.log("getCommunitiesPostsSingleData in error");
            });
        }
