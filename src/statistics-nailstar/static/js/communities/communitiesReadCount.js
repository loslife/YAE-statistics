app.controller('communitiesReadCount', ['$rootScope', '$scope', '$http', 'utilsService', function ($rootScope, $scope, $http, utilsService) {
    ...
    function initReadCount() {
        ...
        getReadCountData($scope.params.num);

        //获取每日圈子评论数
        function getReadCountData(num) {
            ...
            var url = "/svc/dakatongji/communities/communitiesReadCount?num=" + num;
            $http.get(url).success(function (data) {
                ...
                console.log("getReadCountData in error");
            });
        }
