app.controller('communitiesPostShareCount', ['$rootScope', '$scope', '$http', 'utilsService', function ($rootScope, $scope, $http, utilsService) {
    ...
    function initShare(){
        ...
        $scope.CateParams = {
            ...
            num: 20,//初始数据数量
            changeNum: function(){
                getcommunitiesPostShareCountData($scope.CateParams.id, $scope.CateParams.num);
            },
            keyDown: function(){
                if(event.keyCode == 13){
        ...
        //获取播放数据
        function getcommunitiesPostShareCountData(id, num){
            ...
            var url = "/svc/dakatongji/communities/communitiesPostShareCount?id=" + id + "&num=" + num;
            $http.get(url).success(function(data) {
                ...
                console.log("getcommunitiesPostShareCountData in error");
            });
        }
